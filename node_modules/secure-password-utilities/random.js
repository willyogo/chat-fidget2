...
exports.getRandomValues = exports.randomizeCharacters = exports.getRandomNumbersInRange = void 0;
const csprng_1 = require("secure-password-utilities/csprng");
const MAXIMUM_ONE_BYTE_VALUE = 256;
const MAXIMUM_TWO_BYTE_VALUE = 65536;
function getOneByteRandomInteger() {
    const [byte] = (0, csprng_1.getRandomBytes)(1);
    return byte;
}
function getTwoByteRandomInteger() {
    const [byte1, byte2] = (0, csprng_1.getRandomBytes)(2);
...
exports.getRandomNumbersInRange = getRandomNumbersInRange;
/**
...
exports.randomizeCharacters = randomizeCharacters;
/**
...
function getRandomValues(numValues, rangeMax = 256) {
    ...
    if (rangeMax === 256) {
        return (0, csprng_1.getRandomBytes)(numValues);
    }
