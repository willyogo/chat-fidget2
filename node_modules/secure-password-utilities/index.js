...
exports.generatePassphrase = exports.generateCharacters = exports.generatePin = exports.generatePassword = void 0;
const random_1 = require("secure-password-utilities/random");
const constants_1 = require("secure-password-utilities/constants");
/**
...
function generatePassword(length, options) {
    ...
    return createPassword(length, {
        ...
        digits: options.charset?.digits ?? constants_1.DIGIT_CHARSET,
        symbols: options.charset?.symbols ?? constants_1.SYMBOL_CHARSET,
        lowercase: options.charset?.lowercase ?? constants_1.LOWERCASE_CHARSET,
        uppercase: options.charset?.uppercase ?? constants_1.UPPERCASE_CHARSET,
    });
}
...
function createPassword(passwordLength, options, charset) {
    ...
    return (0, random_1.randomizeCharacters)(result);
}
...
function generatePin(length) {
    ...
    return generateCharacters(length, constants_1.DIGIT_CHARSET);
}
...
function generateCharacters(length, charset) {
    ...
    return (0, random_1.getRandomValues)(length, charset.length).reduce((characters, i) => {
...
function generatePassphrase(length, wordlist, sep = '-') {
    ...
    return (0, random_1.getRandomNumbersInRange)(length, 0, wordlist.length).reduce((passphrase, value, i) => {
