...
const encodeDataErrorExamples = {
    address: [
        {
            ...
            errorMessage: 'Unable to encode value: Invalid address value. Expected address to be 20 bytes long, but received 21 bytes.',
        },
    ],
    int8: [
        {
            input: '256',
            errorMessage: 'Unable to encode value: Number "256" is out of range for type "int8".',
        },
    ],
    ...
    bytes1: [
        {
            input: 'a',
            errorMessage: 'An unexpected error occurred: Expected a bytes-like value, got "a".',
        },
        {
            input: 'test',
            errorMessage: 'An unexpected error occurred: Expected a bytes-like value, got "test".',
        },
    ],
    bytes32: [
        {
...
describe('TypedDataUtils.encodeData', function () {
    ...
    describe('V3', function () {
        ...
        it('should throw an error when an atomic property is set to null', function () {
            ...
            expect(() => sign_typed_data_1.TypedDataUtils.encodeData(primaryType, message, types, sign_typed_data_1.SignTypedDataVersion.V3).toString('hex')).toThrow('Unable to encode value: Invalid number. Expected a valid number value, but received "null".');
        });
        ...
        it('should throw an error when trying to encode an unrecognized type', function () {
            ...
            const message = { data: 'test' };
            expect(() => sign_typed_data_1.TypedDataUtils.encodeData('Message', message, types, sign_typed_data_1.SignTypedDataVersion.V3).toString('hex')).toThrow('Unable to encode value: The type "foo" is not supported.');
        });
    ...
    describe('V4', function () {
        ...
        it('should throw an error when an atomic property is set to null', function () {
            ...
            expect(() => sign_typed_data_1.TypedDataUtils.encodeData(primaryType, message, types, sign_typed_data_1.SignTypedDataVersion.V4).toString('hex')).toThrow('Unable to encode value: Invalid number. Expected a valid number value, but received "null".');
        });
        ...
        it('should throw an error when trying to encode an unrecognized type', function () {
            ...
            const message = { data: 'test' };
            expect(() => sign_typed_data_1.TypedDataUtils.encodeData('Message', message, types, sign_typed_data_1.SignTypedDataVersion.V4).toString('hex')).toThrow('Unable to encode value: The type "foo" is not supported.');
        });
        it('should encode data when given extraneous types', function () {
            const types = {
                Message: [{ name: 'data', type: 'string' }],
...
describe('TypedDataUtils.hashStruct', function () {
    ...
    describe('V3', function () {
        ...
        it('should throw an error when an atomic property is set to null', function () {
            ...
            expect(() => sign_typed_data_1.TypedDataUtils.hashStruct(primaryType, message, types, sign_typed_data_1.SignTypedDataVersion.V3).toString('hex')).toThrow('Unable to encode value: Invalid number. Expected a valid number value, but received "null".');
        });
        ...
        it('should throw an error when trying to hash an unrecognized type', function () {
            ...
            const message = { data: 'test' };
            expect(() => sign_typed_data_1.TypedDataUtils.hashStruct('Message', message, types, sign_typed_data_1.SignTypedDataVersion.V3).toString('hex')).toThrow('Unable to encode value: The type "foo" is not supported.');
        });
    ...
    describe('V4', function () {
        ...
        it('should throw an error when an atomic property is set to null', function () {
            ...
            expect(() => sign_typed_data_1.TypedDataUtils.hashStruct(primaryType, message, types, sign_typed_data_1.SignTypedDataVersion.V4).toString('hex')).toThrow('Unable to encode value: Invalid number. Expected a valid number value, but received "null".');
        });
        it('should throw an error when an atomic property is set to undefined', function () {
            const types = {
                Person: [
        ...
        it('should throw an error when trying to hash an unrecognized type', function () {
            ...
            const message = { data: 'test' };
            expect(() => sign_typed_data_1.TypedDataUtils.hashStruct('Message', message, types, sign_typed_data_1.SignTypedDataVersion.V4).toString('hex')).toThrow('Unable to encode value: The type "foo" is not supported.');
        });
        it('should hash data when given extraneous types', function () {
            const types = {
                Message: [{ name: 'data', type: 'string' }],
    ...
    address: [
        {
            ...
            errorMessage: 'Expected a bytes-like value, got "bBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB".',
        },
    ],
    int8: [
        {
...
describe('typedSignatureHash', function () {
    ...
    const invalidTypedMessages = [
        ...
        },
        {
            ...
            errorMessage: 'Unable to encode value: The type "jocker" is not supported.',
    ...
    describe('V1', function () {
        ...
        it('should throw an error when an atomic property is set to null', function () {
            expect(() => (0, sign_typed_data_1.signTypedData)({
                ...
                version: sign_typed_data_1.SignTypedDataVersion.V1,
            })).toThrow('Unable to encode value: Invalid number. Expected a valid number value, but received "null".');
        });
