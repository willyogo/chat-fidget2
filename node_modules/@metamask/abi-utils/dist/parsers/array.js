...
exports.array = {
     ...
     */
    decode(_a) {
        var { type, value } = _a, rest = __rest(_a, ["type", "value"]);
        const [arrayType, fixedLength] = (0, exports.getArrayType)(type);
        if (fixedLength) {
            const result = tuple_1.tuple.decode(Object.assign({ type: (0, exports.getTupleType)(arrayType, fixedLength), value }, rest));
