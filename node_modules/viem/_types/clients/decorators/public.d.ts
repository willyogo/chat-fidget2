...
import { type SimulateParameters, type SimulateReturnType } from '../../actions/public/simulate.js';
...
export type PublicActions<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     */
    simulate: <const calls extends readonly unknown[]>(args: SimulateParameters<calls>) => Promise<SimulateReturnType<calls>>;
    /**
