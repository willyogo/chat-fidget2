...
export type SimulateParameters<calls extends readonly unknown[] = readonly unknown[]> = {
    /** Blocks to simulate. */
    blocks: readonly {
        /** Block overrides. */
...
export type SimulateReturnType<calls extends readonly unknown[] = readonly unknown[]> = readonly (Block & {
...
export type SimulateErrorType = AssertRequestErrorType | DecodeFunctionResultErrorType | EncodeFunctionDataErrorType | FormatBlockErrorType | FormatTransactionRequestErrorType | GetNodeErrorReturnType | ParseAccountErrorType | SerializeStateOverrideErrorType | NumberToHexErrorType | ErrorType;
/**
 ...
 */
export declare function simulate<chain extends Chain | undefined, const calls extends readonly unknown[]>(client: Client<Transport, chain>, parameters: SimulateParameters<calls>): Promise<SimulateReturnType<calls>>;
export {};
